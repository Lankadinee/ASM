...
def gen_imdb_schema(csv_path=""):
    ...
    # title
    schema.add_table(Table('title', attributes=['id', 'kind_id', 'production_year'],
                           csv_file_location=csv_path.format('title'),
                           table_size=3486660))

    # movie_info_idx
    schema.add_table(Table('movie_info_idx', attributes=['movie_id', 'info_type_id'],
                           csv_file_location=csv_path.format('movie_info_idx'),
                           table_size=3147110))

    # movie_info
    schema.add_table(Table('movie_info', attributes=['movie_id', 'info_type_id'],
    ...
    # cast_info
    schema.add_table(Table('cast_info', attributes=['movie_id', 'role_id'],
    ...
    # movie_keyword
    schema.add_table(Table('movie_keyword', attributes=['movie_id', 'keyword_id'],
    ...
    # movie_companies
    schema.add_table(Table('movie_companies', attributes=['movie_id', 'company_id', 'company_type_id'],
